...
import type { JiraEpic, JiraTicket, SprintCapacity, ViewMode } from '@/shared/types';
...
export const POST = async (request: NextRequest) => {
  try {
    ...
    const { epicKeys, sprintCapacities, viewMode, maxDevelopers = 5, includeWeekends = false } = body;
